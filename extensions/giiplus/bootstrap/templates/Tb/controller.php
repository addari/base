...
class <?php echo $this->controllerClass; ?> extends <?php echo $this->baseControllerClass."\n"; ?>
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow authenticated user to perform 'index' actions
				'actions'=>array('index'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/index'),
			),
			array('allow',  // allow authenticated user to perform 'view' actions
				'actions'=>array('view'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/view'),
			),
			array('allow', // allow authenticated user to perform 'create' actions
				'actions'=>array('create'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/create'),
			),
			array('allow',  // allow authenticated user to perform 'update' actions
				'actions'=>array('update'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/update'),
			),
			array('allow',  // allow authenticated user to perform 'GeneratePdf' actions
				'actions'=>array('GeneratePdf'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/GeneratePdf'),
			),
			array('allow',  // allow authenticated user to perform 'GenerateExcel' actions
				'actions'=>array('GenerateExcel'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/GenerateExcel'),
			),
			array('allow', // allow authenticated user to perform 'admin' actions
				'actions'=>array('admin'),
				//'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/admin'),
			),
			array('allow', // allow authenticated user to perform 'delete' actions
				'actions'=>array('delete'),
				#'roles'=>array('<?php echo $this->modelClass; ?>','<?php echo $this->modelClass; ?>/delete'),
			),
        ...
        public function actionGeneratePdf() 
	{
		...
		Yii::import('application.extensions.giiplus.bootstrap.*');
                require_once(Yii::getPathOfAlias('ext').'/giiplus/bootstrap/tcpdf/tcpdf.php');
                require_once(Yii::getPathOfAlias('ext').'/giiplus/bootstrap/tcpdf/config/lang/eng.php');
